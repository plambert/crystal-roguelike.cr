...
module Roguelike
  ...
  #
  # Everything costs one tick but getting a suit of armour on or off. The
  ...
  module Costs
    ...
    # Getting a suit of armour on or off.
    #
    # Three turns. A cap goes on in one and chain mail does not, and the
    # difference is what makes changing armour with something in the room a
    # decision rather than a keystroke.
    BODY = 3 * Pace::TICK

    # What filling *slot* costs, or emptying it again.
    #
    # Body armour is the slow one. Everything else a character holds or wears
    # takes a turn.
